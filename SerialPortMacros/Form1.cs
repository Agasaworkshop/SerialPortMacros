    ...
    public partial class Form1 : Form
    {
        ...
        public void scriptcheck(string data, bool p1, bool p2, bool p3, bool p4)
        {
            if (is_running)
            {
                ...
                {
                    if (script.active && script.key == data && ((p1 == script.p1 == true) || (p2 == script.p2 == true) || (p3 == script.p3 == true) || (p4 == script.p4 == true)))
                        if (script.trigger == 1)
                        {
                            Thread inputThread = new Thread(() =>
                            {
                                scr_KeyPress(script.keypress);
                            });
                            inputThread.Start();
                        }
        ...
        public void scr_KeyPress(string car)
        {
            int time = 0;
            bool raw = false;
            bool press = false;
