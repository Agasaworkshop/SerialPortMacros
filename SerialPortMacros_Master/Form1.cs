...
namespace SerialPortMacros
{
    public partial class Form1 : Form
    {
        ...
        {
            Serial_port_data2(port1, 1, true, false, false, false, opn_p1, checkBox1, Color.Red,mes1);
        }
        private async void SerialPort_DataReceived2(object sender, SerialDataReceivedEventArgs e)
        {
            Serial_port_data2(port2, 2, false, true, false, false, opn_p2, checkBox2, Color.Blue,mes2);
        }
        private async void SerialPort_DataReceived3(object sender, SerialDataReceivedEventArgs e)
        {
            Serial_port_data2(port3, 3,false,false,true,false,opn_p3, checkBox3, Color.Yellow,mes3);
        }
        private async void SerialPort_DataReceived4(object sender, SerialDataReceivedEventArgs e)
        {
           Serial_port_data2(port4, 4,false,false,false,true,opn_p4,checkBox4, Color.Green,mes4);
        }
        ...
        public async void Serial_port_data2(SerialPort port, int num, bool po1, bool po2, bool po3, bool po4, bool opn, CheckBox checkbox, Color color,StringBuilder sb)
        {
            string data = await ReadSerialDataAsync(port);
            if (!string.IsNullOrEmpty(data))
                this.Invoke((Action)(() =>
                {
